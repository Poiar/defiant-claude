...
exports.STATUS_TO_CODE = exports.ERROR_CODES = void 0;
exports.formatError = formatError;
exports.formatExhaustedError = formatExhaustedError;
exports.scrubCredentials = scrubCredentials;
exports.isStreamingClient = isStreamingClient;
...
exports.STATUS_TO_CODE = {
    401: exports.ERROR_CODES.AUTH_FAILED,
    403: exports.ERROR_CODES.FORBIDDEN,
    404: exports.ERROR_CODES.NOT_FOUND,
    408: exports.ERROR_CODES.UPSTREAM_TIMEOUT,
    413: exports.ERROR_CODES.BODY_TOO_LARGE,
    429: exports.ERROR_CODES.RATE_LIMITED,
    502: exports.ERROR_CODES.UPSTREAM_ERROR,
    503: exports.ERROR_CODES.UPSTREAM_UNAVAILABLE,
    504: exports.ERROR_CODES.GATEWAY_TIMEOUT,
};
...
function formatError(status, templateVars, isDev) {
    const entry = exports.STATUS_TO_CODE[status] || {
        code: 'UPSTREAM_ERROR',
    ...
    const error = { type: 'api_error', message, error_code: entry.ecode };
    if (isDev) {
...
function formatExhaustedError(lastStatus, lastBody, isDev, qualityReason) {
...
function isStreamingClient(headers, parsedBody) {
