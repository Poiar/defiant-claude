...
export const ERROR_CODES: Record<string, ErrorCodeEntry> = {
    AUTH_FAILED:         { code: 'AUTH_FAILED',         status: 401, message: 'Upstream provider rejected credentials',           ecode: 'E001' },
    FORBIDDEN:           { code: 'FORBIDDEN',           status: 403, message: 'Access denied by upstream provider',                ecode: 'E002' },
    NOT_FOUND:           { code: 'NOT_FOUND',           status: 404, message: 'Resource not found on upstream provider',           ecode: 'E003' },
    UPSTREAM_TIMEOUT:    { code: 'UPSTREAM_TIMEOUT',    status: 408, message: 'Request to upstream provider exceeded time limit',  ecode: 'E004' },
    RATE_LIMITED:        { code: 'RATE_LIMITED',        status: 429, message: 'Too many requests to upstream provider',            ecode: 'E005' },
    UPSTREAM_ERROR:      { code: 'UPSTREAM_ERROR',      status: 502, message: 'Upstream provider replied with HTTP {status}',      ecode: 'E006' },
    UPSTREAM_UNAVAILABLE:{ code: 'UPSTREAM_UNAVAILABLE',status: 503, message: 'Upstream provider is not reachable right now',     ecode: 'E007' },
    GATEWAY_TIMEOUT:     { code: 'GATEWAY_TIMEOUT',     status: 504, message: 'Upstream provider did not respond in time',         ecode: 'E008' },
    STREAM_DEAD:         { code: 'STREAM_DEAD',         status: 502, message: 'Provider returned 200 but stream produced no data',  ecode: 'E009' },
    BODY_TOO_LARGE:      { code: 'BODY_TOO_LARGE',      status: 413, message: 'Request body exceeds 10MB limit',                  ecode: 'E010' },
    UNKNOWN_PROVIDER:    { code: 'UNKNOWN_PROVIDER',    status: 502, message: 'Unknown provider: {provider}',                     ecode: 'E011' },
    ALL_PROVIDERS_FAILED:{ code: 'ALL_PROVIDERS_FAILED',status: 502, message: 'All configured providers failed',                  ecode: 'E012' },
    NO_DEFAULT_PROVIDER: { code: 'NO_DEFAULT_PROVIDER', status: 502, message: 'No default provider configured',                   ecode: 'E013' },
};
